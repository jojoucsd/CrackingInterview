//Building min and max Heap in JS and solve running median
var minHeap;
var maxHeap;

function main() {
    // n is how many numbers will be added 
    var n = parseInt(readLine());
    var a = [];
    var i = 0;
    // Hackerank code loop thru input and generate input array
